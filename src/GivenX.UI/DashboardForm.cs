...
public sealed class DashboardForm : Form
{
    ...
    public DashboardForm(bool startHidden = false)
    {
        ...
        Text = "GivenX Shield Beta Unificada 1.6.2-R9 HF9"; BackColor = Bg; ForeColor = Color.White; Font = new("Segoe UI", 10); MinimumSize = new(1000, 760); Size = new(1180, 820); StartPosition = FormStartPosition.CenterScreen;
